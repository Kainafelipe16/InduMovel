...
namespace InduMovel.Controllers
{
    ...
    public class CarrinhoController : Controller
    {
        ...
        public CarrinhoController(Carrinho carrinho, IMovelRepository
        movelRepository)
        {
            _carrinho = carrinho;
        ...
        {
            var movelSelecionado =

            _movelRepository.Moveis.FirstOrDefault(l => l.MovelId == movelId);
        ...
        public IActionResult RemoverCarrinho(int movelId)
        {
            ...
            if (movelSelecionado != null)
            {
                _carrinho.RemoverItemDoCarrinhoCompra(movelSelecionado);
            }
            return RedirectToAction("Index");
        }
    }
